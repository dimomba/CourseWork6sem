...
export function Header() {
    ...
    return (
        <div className={styles.header}>
            ...
            <a href="/upload" className={styles.uploadLink}><div className={styles.divUpload}><i className={styles.iUpload}>Загрузить фото</i><i className={styles.plusIcon} class="fa fa-plus"></i></div></a>
            {username ? (
